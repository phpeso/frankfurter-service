...
final class UserAgentTest extends TestCase
{
    public function testUserAgent(): void
    {
        ...
        $clientVersion = InstalledVersions::getPrettyVersion('peso/frankfurter-service');

        $service->send(new CurrentExchangeRateRequest('EUR', 'USD'));

        $request = $http->getLastRequest();

        self::assertEquals("Peso/$pesoVersion Frankfurter/$clientVersion", $request->getHeaderLine('User-Agent'));
    }
    ...
    public function testCustomUserAgent(): void
    {
        ...
        self::assertEquals(
            "Peso/$pesoVersion Frankfurter/$clientVersion CustomSuffix/1.0",
